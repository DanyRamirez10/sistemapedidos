...
<body>
   ...
   <div class="container">
      ...
      <form id="login_pass" class="form-horizontal form-bordered form-control-borderless">
            ...
            <div id="div_pass" class="col-xs-12"></div>
   ...
   <script src="lib/login.js?v=300324"></script>
</body>
</html>