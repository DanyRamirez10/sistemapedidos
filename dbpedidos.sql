...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2024 a las 01:53:36
...
(2, NULL, 'Americo', 'perez', 'Ramirez', 'cliente2@gmail.com', 902290568, 'M', 'Av.cusco', 'pKehlaKY ', 1, 'assets/uploads/2023/08/2_foto.jpg', '2023-08-15 00:31:21'),
...
(19, '71104924', 'DANY SANTIAGO', 'RAMIREZ', 'LIMAS', '201067@unamba.edu.pe', 902290500, 'M', 'Av.cusco', 'pKehlaKY', 1, 'assets/uploads/2023/05/perfil.png', '2024-04-08 18:52:00');
...
(228, 2, '2024-05-22 17:09:00', 't80v2rjrde1', 1),
(229, 2, '2024-05-27 21:33:35', '5hungmrlldb', 1);
...
--
ALTER TABLE `usuario_login`
  MODIFY `codUL` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=230;
