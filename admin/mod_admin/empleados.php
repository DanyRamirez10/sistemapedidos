<?php include_once 'sections/t_inicio.php';?>    
    <body>
            ...
            <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
                ...
                <div id="main-container">
                    ...
                    <div id="page-content">
                                    ...
                                    <div class="block">
                                        <div class="block-title">
                                            ...
                                            <a href="#" class="btn btn-alt btn-sm btn-primary" 
                                                data-toggle="modal" data-target="#modal-Insertempleados" 
                                                title="Nuevo Registro Producto">
                                             <i  class="fa fa-plus"></i> Nuevo
                                             </a>
                                            </div>
                                            <h2><strong>Empleados</strong> Registrados</h2>
                                        </div>
                                         <div class="block-body">
                                            <div class="outer_div_empleados"></div><!-- Datos ajax Final -->
                                        </div>
                                    </div>
                                </div> 
                        </div>
                        <div id="modal-Insertempleados" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="modal-title text-center text-danger">Inserta Nuevo Motoquero<h2>
                                    </div>
                                    <div class="modal-body">
                                        <form id="form_Inser_empleados" class="form-horizontal form-bordered">
                                            ...
                                            <div class="col-md-12" id="div_insert_empleado"></div>
                        ...
                        <div id="modal-UpdateEmpleado" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form id="form_Upd_empleado" class="form-horizontal form-bordered">
                                            <div class="form-group">                                                                                         
                                                <div class="col-md-4 text-center">
                                            ...
                                            <div class="col-md-12" id="div_upd_empleado"></div>
                                            <div class="form-group form-actions">
                                                <div class="col-md-12 text-center">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                        ...
                        <div id="modal-EstadoEmpleado" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="modal-title text-center text-danger"><h2>
                                    ...
                                    <div class="modal-body">
                                        <form id="form_est_empleado" class="form-horizontal form-bordered">
                                            <div class="form-group"> 
                                                <input type="hidden" name="id" id="id" >
                                                <div class="col-md-12 text-center">
                                                    <label class="radio-inline">
                                            ...
                                            <div class="col-md-12" id="div_est_empleado"></div>
                                            <div class="form-group form-actions">
                                                <div class="col-md-12 text-center">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                                                    <button type="submit" class="btn btn-primary">Actualizar</button>
                        ...
                        <div id="modal-DeleteEmpleado" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="modal-title text-center text-danger"><h2>
                                    ...
                                    <div class="modal-body">
                                        <form id="form_del_empleado" class="form-horizontal form-bordered">
                                            <div class="form-group">                                                                                         
                                                <div class="col-md-12 text-center">
                                                    <input type="hidden" name="id" id="id" >
                                            ...
                                            <div class="col-md-12" id="div_del_empleado"></div>
                                            <div class="form-group form-actions">
                                                <div class="col-md-12 text-center">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
        ...
        <script src="js/script.js?v=280324"></script> 
        <script>
